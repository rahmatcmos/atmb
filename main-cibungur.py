...
class Main(QtGui.QWidget, main_ui.Ui_main):
    def __init__(self):
        ...
        # buat cek listrik
        # self.pin_cek_listrik = port.PA12
        # gpio.init()
        # gpio.setcfg(self.pin_cek_listrik, gpio.INPUT)
        # gpio.pullup(self.pin_cek_listrik, gpio.PULLUP)

        # self.timer_cek_listrik = QtCore.QTimer()
        # self.timer_cek_listrik.timeout.connect(self.cek_listrik)
        # self.timer_cek_listrik.start(60000)
    ...
    # def cek_listrik(self):
    #     if gpio.input(self.pin_cek_listrik) == 0:
    #         # todo: kirim notifikasi ke server
    #         pass
    ...
    def keypad_pressed_event(self, key):
        ...
        # if self.password == '*126#':
        #     self.window = IsiBeras()
        #     self.timer.stop()
        #     self.timer_cek_listrik.stop()
        #     self.keypad_thread.terminate()
        #     self.scan_thread.terminate()
